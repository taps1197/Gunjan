...
a.prototype._onProgressOver=function(){this._hovering=!0;this._$hoverLine.css("display","block");this._$duration.addClass("show").removeClass("hide");this._$document.on("mousemove",$.proxy(this._onCursorMove,this))};a.prototype._onProgressOut=function(a){this._dragging?this._hovering=!1:(this._hovering=!1,this._$duration.addClass("hide").removeClass("show"),this._$hoverLine.css("display","none"),this._thumbnail&&this._thumbnail.hideThumbnail(),this._$document.off("mousemove"))};a.prototype._onCursorMove=
function(a){this._dragging||this._onProgressMouseMove(a)};a.prototype._onProgressMouseMove=function(a){var b,g;b=this._$vidoeTimeLineWrapper.offset().left;g=this.$el.offset().left;a=this.getClickXPosOnScreen(a)-b;b-=g;g=this._$vidoeTimeLineWrapper.outerWidth();if(0<=a&&a<=g){var h=a/g*this._duration;this._thumbnail&&this._thumbnail.showThumbnail(h,a,b,g);this.updateProgressTooltip(h);var h=this._$duration.outerWidth(!0)/2,k=0,k=0>a-h?0:a-h;a>=g-h&&(k=g-this._$duration.outerWidth(!0));if(this._thumbnail){var m=
this._thumbnail.settings.thumbnailWidth/2,k=0>k-(m-h)?m-h:k;k+h+m>g&&(k=g-(m+h))}this._$duration.css("left",k+b);this._$duration.addClass("show").removeClass("hide");b=a-Number(this._$hoverLine.data("x"));0>b?this._$hoverLine.addClass("dark"):this._$hoverLine.removeClass("dark");this._$hoverLine.data("nw",a);this._$hoverLine.css("transform","scaleX("+b+")")}else this._$duration.addClass("hide").removeClass("show")};a.prototype.updateProgressBar=function(a){this._sliding||this._percent==a||this._updateProgressBar(a)};
a.prototype.updateProgressTooltip=function(a){this._$duration.html(StringUtil.formatTime(a))};a.prototype._updateTimelineSliderAriaText=function(a){a=StringUtil.formatTime(a,!0);var b=StringUtil.formatTime(this._duration,!0);this._$slider.attr("aria-valuetext",a+" of "+b)};a.prototype.setDuration=function(a){this._duration=a;return this};a.prototype.getDuration=function(){return this._duration};a.prototype.getPercent=function(){return this._percent};a.prototype.isSliding=function(){return this._sliding||
this._hovering};a.prototype.changeSize=function(a,b){};a.prototype.isThumbnailHidden=function(){return this._thumbnail?this._thumbnail.isThumbnailHidden():!0};a.prototype.enable=function(){this.$el.css("pointer-events","auto")};a.prototype.disable=function(){this.$el.css("pointer-events","none")};a.prototype.getFocusableElements=function(){return[this.$el.get(0)]};return a}(com$adobe$ccv$view.BaseView);e.ProgressControl=f})(com$adobe$ccv$controls||(com$adobe$ccv$controls={}));
...
'<div class="videogradient"></div><div class="timelinewrap" aria-label="timeline slider control" tabindex="2"><div class="timelineknob"><div class="timeknob"></div></div><div class="duration"> 0.00 </div><div class="videotimewrap"><input class="timelineslide" type="range"  min="0" max="1" step="0.0001" aria-label="timeline slider"><div class="timeline" style="width:0%;"></div><div class="buffer" style="left: 0px; right: 0%;"></div><div class="track"></div><div class="hoverline dark"></div></div></div><div class="controlsleft"><button class="playpause videobutton playicon" tabindex="1">play</button><div class="videotime"><span class="timelabel">0:00</span><span class="vduration"></span></div></div><div class="controlsright"><div class="volumecontrols"><button class="videobutton mute level2 muteicon" tabindex="4">mute</button><span class="standard volumewrap"><div class="slidelabel" style="display:none;"><span class="sll">Volume</span><span class="slr volumelevel">0</span></div><div style="position:relative;z-index:1;height:100%;"><input type="range" class="slider volume" tabindex="3" value="100" max="100" aria-label="volume slider control"></div></span><div class="volumeslide" tabindex="-1" aria-label="volume slider"><div class="volumetracks"><div class="volumetrack"></div><div class="volumefill" style="width: 0%;"></div></div><div class="volumeknob" style="transform: translateX(-48px);"><div class="volumeknobfill"></div></div></div></div><button class="videobutton fullscreen" tabindex="5">fullscreen</button></div>')};
